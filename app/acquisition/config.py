...
DEFAULT_COUNTRY_PROFILES: Dict[str, Dict[str, Any]] = {
    ...
    "DE": {
        ...
        "target_cities": ["Berlin", "Munich", "Frankfurt", "Hamburg", "Cologne", "Stuttgart"],
        "target_niches": ["commercial-hvac", "roofing-contractors", "dental-clinics", "commercial-lawyers"],
        "discovery_query_templates": ["{niche} in {city}, Germany", "{city} professional {niche}"],
        "qualification_rules": {"min_website_age_years": 1, "require_ssl": True, "require_phone_or_email": True, "max_initial_deal_size_usd": 5000.0},
        "outreach_rules": {"max_messages_per_day": 10, "preferred_contact_channel": "email", "working_hours_start": 9, "working_hours_end": 17},
        "compliance_settings": {"gdpr_compliant": True, "opt_out_link_mandatory": True, "risk_score_limit": 25.0},
        "max_daily_discovery": 30,
        "concurrency_limit": 2
    },
    "FR": {
        ...
        "target_cities": ["Paris", "Lyon", "Marseille", "Toulouse", "Nice", "Bordeaux"],
        "target_niches": ["commercial-hvac", "roofing-contractors", "dental-clinics", "commercial-lawyers"],
        "discovery_query_templates": ["{niche} in {city}, France", "{city} top {niche} services"],
        "qualification_rules": {"min_website_age_years": 1, "require_ssl": True, "require_phone_or_email": True, "max_initial_deal_size_usd": 5000.0},
        "outreach_rules": {"max_messages_per_day": 10, "preferred_contact_channel": "email", "working_hours_start": 9, "working_hours_end": 17},
        "compliance_settings": {"gdpr_compliant": True, "opt_out_link_mandatory": True, "risk_score_limit": 25.0},
        "max_daily_discovery": 30,
    ...
    "NL": {
        ...
        "target_cities": ["Amsterdam", "Rotterdam", "The Hague", "Utrecht", "Eindhoven"],
        "target_niches": ["commercial-hvac", "roofing-contractors", "dental-clinics", "commercial-electricians"],
        "discovery_query_templates": ["{niche} in {city}, Netherlands", "{city} {niche} specialists"],
        "qualification_rules": {"min_website_age_years": 1, "require_ssl": True, "require_phone_or_email": True, "max_initial_deal_size_usd": 5000.0},
        "outreach_rules": {"max_messages_per_day": 10, "preferred_contact_channel": "email", "working_hours_start": 9, "working_hours_end": 17},
        "compliance_settings": {"gdpr_compliant": True, "opt_out_link_mandatory": True, "risk_score_limit": 25.0},
        "max_daily_discovery": 30,
    ...
    "SE": {
        ...
        "target_cities": ["Stockholm", "Gothenburg", "Malmo", "Uppsala"],
        "target_niches": ["commercial-hvac", "roofing-contractors", "dental-clinics", "it-support"],
        "discovery_query_templates": ["{niche} in {city}, Sweden", "best {niche} {city}"],
        "qualification_rules": {"min_website_age_years": 1, "require_ssl": True, "require_phone_or_email": True, "max_initial_deal_size_usd": 5000.0},
        "outreach_rules": {"max_messages_per_day": 10, "preferred_contact_channel": "email", "working_hours_start": 9, "working_hours_end": 17},
        "compliance_settings": {"gdpr_compliant": True, "opt_out_link_mandatory": True, "risk_score_limit": 25.0},
        "max_daily_discovery": 30,
    ...
    "SG": {
        ...
        "target_cities": ["Singapore", "Jurong", "Tampines", "Woodlands"],
        "target_niches": ["commercial-hvac", "dental-clinics", "commercial-lawyers", "accounting-services"],
        "discovery_query_templates": ["{niche} in {city}, Singapore", "{city} professional {niche}"],
        "qualification_rules": {"min_website_age_years": 1, "require_ssl": True, "require_phone_or_email": True, "max_initial_deal_size_usd": 5000.0},
        "outreach_rules": {"max_messages_per_day": 10, "preferred_contact_channel": "email", "working_hours_start": 9, "working_hours_end": 18},
        "compliance_settings": {"pdpa_compliant": True, "opt_out_link_mandatory": True, "risk_score_limit": 25.0},
        "max_daily_discovery": 30,
        "concurrency_limit": 2
    },
    "JP": {
        ...
        "currency": "JPY",
        "timezone": "Asia/Tokyo",
        "target_cities": ["Tokyo", "Osaka", "Yokohama", "Nagoya"],
        "target_niches": ["commercial-hvac", "dental-clinics", "professional-services"],
        "discovery_query_templates": ["{niche} in {city}, Japan", "leading {niche} {city}"],
        "qualification_rules": {"min_website_age_years": 1, "require_ssl": True, "require_phone_or_email": True, "max_initial_deal_size_usd": 5000.0},
        "outreach_rules": {"max_messages_per_day": 10, "preferred_contact_channel": "email", "working_hours_start": 9, "working_hours_end": 18},
        "compliance_settings": {"opt_out_link_mandatory": True, "risk_score_limit": 25.0},
        "max_daily_discovery": 30,
        "concurrency_limit": 2
    },
    "NZ": {
        ...
        "target_cities": ["Auckland", "Wellington", "Christchurch", "Hamilton"],
        "target_niches": ["commercial-hvac", "roofing-contractors", "dental-clinics", "commercial-electricians"],
        "discovery_query_templates": ["{niche} in {city}, New Zealand", "{city} certified {niche}"],
        "qualification_rules": {"min_website_age_years": 1, "require_ssl": True, "require_phone_or_email": True, "max_initial_deal_size_usd": 4500.0},
        "outreach_rules": {"max_messages_per_day": 10, "preferred_contact_channel": "email", "working_hours_start": 9, "working_hours_end": 17},
        "compliance_settings": {"opt_out_link_mandatory": True, "risk_score_limit": 25.0},
        "max_daily_discovery": 30,
        "concurrency_limit": 2
    ...
    "IE": {
        ...
        "target_cities": ["Dublin", "Cork", "Galway", "Limerick"],
        "target_niches": ["commercial-hvac", "roofing-contractors", "dental-clinics", "commercial-lawyers"],
        "discovery_query_templates": ["{niche} in {city}, Ireland", "{city} professional {niche}"],
        "qualification_rules": {"min_website_age_years": 1, "require_ssl": True, "require_phone_or_email": True, "max_initial_deal_size_usd": 5000.0},
        "outreach_rules": {"max_messages_per_day": 10, "preferred_contact_channel": "email", "working_hours_start": 9, "working_hours_end": 17},
        "compliance_settings": {"gdpr_compliant": True, "opt_out_link_mandatory": True, "risk_score_limit": 25.0},
        "max_daily_discovery": 30,
    ...
    "ES": {
        ...
        "target_cities": ["Madrid", "Barcelona", "Valencia", "Seville", "Malaga"],
        "target_niches": ["commercial-hvac", "roofing-contractors", "dental-clinics", "commercial-electricians"],
        "discovery_query_templates": ["{niche} in {city}, Spain", "{city} top rated {niche}"],
        "qualification_rules": {"min_website_age_years": 1, "require_ssl": True, "require_phone_or_email": True, "max_initial_deal_size_usd": 4500.0},
        "outreach_rules": {"max_messages_per_day": 10, "preferred_contact_channel": "email", "working_hours_start": 9, "working_hours_end": 18},
        "compliance_settings": {"gdpr_compliant": True, "opt_out_link_mandatory": True, "risk_score_limit": 25.0},
        "max_daily_discovery": 30,
    ...
    "IT": {
        ...
        "target_cities": ["Milan", "Rome", "Turin", "Bologna", "Florence"],
        "target_niches": ["commercial-hvac", "roofing-contractors", "dental-clinics", "commercial-lawyers"],
        "discovery_query_templates": ["{niche} in {city}, Italy", "{city} commercial {niche}"],
        "qualification_rules": {"min_website_age_years": 1, "require_ssl": True, "require_phone_or_email": True, "max_initial_deal_size_usd": 4500.0},
        "outreach_rules": {"max_messages_per_day": 10, "preferred_contact_channel": "email", "working_hours_start": 9, "working_hours_end": 18},
        "compliance_settings": {"gdpr_compliant": True, "opt_out_link_mandatory": True, "risk_score_limit": 25.0},
        "max_daily_discovery": 30,
    ...
    "CH": {
        ...
        "target_cities": ["Zurich", "Geneva", "Basel", "Lausanne", "Bern"],
        "target_niches": ["commercial-hvac", "dental-clinics", "commercial-lawyers", "accounting-services"],
        "discovery_query_templates": ["{niche} in {city}, Switzerland", "{city} professional {niche}"],
        "qualification_rules": {"min_website_age_years": 1, "require_ssl": True, "require_phone_or_email": True, "max_initial_deal_size_usd": 6000.0},
        "outreach_rules": {"max_messages_per_day": 10, "preferred_contact_channel": "email", "working_hours_start": 9, "working_hours_end": 17},
        "compliance_settings": {"swiss_fadp_compliant": True, "opt_out_link_mandatory": True, "risk_score_limit": 25.0},
        "max_daily_discovery": 30,
        "concurrency_limit": 2
    }
}
