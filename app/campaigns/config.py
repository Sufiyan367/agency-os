...
DEFAULT_18_COUNTRIES: List[Dict[str, Any]] = [
    ...
    {"code": "DE", "name": "Germany", "timezone": "Europe/Berlin", "currency": "EUR", "daily_quota": 0, "enabled": False, "sending_window_start": 9, "sending_window_end": 17, "compliance_framework": "EU-GDPR / UWG", "requires_postal_address": True, "requires_opt_out_link": True},
    ...
    {"code": "ES", "name": "Spain", "timezone": "Europe/Madrid", "currency": "EUR", "daily_quota": 0, "enabled": False, "sending_window_start": 9, "sending_window_end": 18, "compliance_framework": "EU-GDPR / LSSI-CE", "requires_postal_address": True, "requires_opt_out_link": True},
    {"code": "IT", "name": "Italy", "timezone": "Europe/Rome", "currency": "EUR", "daily_quota": 0, "enabled": False, "sending_window_start": 9, "sending_window_end": 18, "compliance_framework": "EU-GDPR / Codice Privacy", "requires_postal_address": True, "requires_opt_out_link": True},
    {"code": "CH", "name": "Switzerland", "timezone": "Europe/Zurich", "currency": "CHF", "daily_quota": 0, "enabled": False, "sending_window_start": 9, "sending_window_end": 17, "compliance_framework": "Swiss FADP / UWG Art 3", "requires_postal_address": True, "requires_opt_out_link": True},
