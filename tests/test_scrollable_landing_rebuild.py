...
async def test_scrollable_landing_sections_and_content():
    ...
    async with AsyncClient(transport=transport, base_url="http://test") as client:
        ...
        assert ('href="#problems"' in html or 'href="#automate"' in html)
        ...
        assert ("WHAT WE BUILD" in html or "What we build" in html)
        ...
        # 6. Section 04: Customer Problems & Solutions (#problems or #automate)
        assert ('id="problems"' in html or 'id="automate"' in html)

        # 7. Section 05: How It Works (#how-it-works)
        assert 'id="how-it-works"' in html
        assert ("HOW WE WORK" in html or "How It Works" in html)
        ...
        if 'id="pricing"' in html:
            assert "Solutions are scoped" in html
        ...
        assert ("Agency OS" in html or "AGENCY OS" in html)
        ...
        assert ('id="consultationName"' in html or 'id="consultationCompany"' in html)
